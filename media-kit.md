...
<style>
/* Media Kit specific styles – move to site.css later */
.media-kit-hero {
...
<main class="container">
  ...
  <a href="/media-kit-print.html" class="pdf-button" target="_blank">
    ...
    <div class="media-kit-badges">
      ...
      <span class="media-kit-badge">Comparison Guides</span>
  ...
  <div class="kit-grid">
    ...
    <div class="kit-card">
      ...
      <p>We are open to affiliate partnerships, product review opportunities, sponsored educational content, and long-term collaborations with relevant software brands.</p>
    </div>
  </div>
  ...
  <section class="kit-section">
    <h2>Who We Reach</h2>
    <ul>
      <li>Small business owners looking for software to improve operations and marketing</li>
      <li>Freelancers and consultants comparing tools before subscribing</li>
      <li>Digital marketers researching platforms for SEO, email, and growth</li>
      <li>Decision-stage readers who prefer practical comparisons over hype</li>
    </ul>
    <div class="quote-box">
  ...
  <section class="kit-section">
    ...
    <p>We take a straightforward approach to content. Our goal is not to overwhelm readers with buzzwords, but to help them understand what a product does, who it suits, and what to expect before starting a trial or subscription.</p>
    <ul>
      <li>Clear explanations of features and pricing</li>
      <li>Pros and cons readers can actually use</li>
      <li>Practical comparison content for decision-making</li>
      <li>Honest disclosure when affiliate links are present</li>
    </ul>
  </section>
  ...
  <section class="kit-section">
    ...
    <div class="brand-strip">
      <span class="brand-pill">Email Marketing Tools</span>
      <span class="brand-pill">SEO Software</span>
      <span class="brand-pill">Project Management Tools</span>
      <span class="brand-pill">PDF & Document Tools</span>
      <span class="brand-pill">Business Software</span>
      <span class="brand-pill">Productivity Platforms</span>
    </div>
  </section>

  <section class="kit-section">
    <h2>Partnership Opportunities</h2>
    <p>We are open to partnerships that align with our audience and editorial direction. We prefer working with products that provide real value to professionals, teams, and growing businesses.</p>
    <div class="partner-options">
      <div class="partner-option"><strong>Product Reviews</strong> In-depth, content-led reviews focused on positioning, features, pricing, and user fit.</div>
      <div class="partner-option"><strong>Comparison Placements</strong> Inclusion in comparison-style content where your product is relevant to the reader’s decision.</div>
      <div class="partner-option"><strong>Affiliate Partnerships</strong> Ongoing performance-based promotion through educational content and buyer-intent articles.</div>
      <div class="partner-option"><strong>Sponsored Educational Content</strong> Brand-aligned content that remains useful, transparent, and reader-focused.</div>
    </div>
  </section>
  ...
  <section class="kit-section">
    <h2>Selected Topics We Cover</h2>
    <ul>
      <li>Email marketing software reviews and comparisons</li>
      <li>SEO tool reviews and educational buying guides</li>
      <li>Project management platform reviews</li>
      <li>Business software recommendations for small teams and solo professionals</li>
    </ul>
  </section>
