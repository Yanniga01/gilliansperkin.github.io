...
<style>
/* ============================================================
   SmartGuideHubs Homepage — Professional & Clean
   ============================================================ */
...
.hp-cat-pill__icon { font-size: 1.6rem; }
.hp-cat-pill__label { font-size: 0.85rem; font-weight: 700; color: var(--hp-text); }
.hp-cat-pill:hover .hp-cat-pill__label { color: #0e7490; }

.hp-cat-section { margin-bottom: 2.5rem; }
.hp-section-header {
  display: flex;
...
@media (max-width: 768px) {
  .hp-hero { padding: 2.5rem 1.5rem; }
  .hp-hero h1 { font-size: 1.8rem; }
  .hp-cat-cards { grid-template-columns: repeat(2, 1fr); }
  .hp-cat-grid { grid-template-columns: 1fr; }
  .hp-tools-band { flex-direction: column; text-align: center; }
  .hp-trust-bar { gap: 1rem; }
}
